...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.7.3/contracts/utils/Address.sol";
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.7.3/contracts/utils/Context.sol";
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.7.3/contracts/utils/math/Math.sol";
...
contract VestingWallet is Context {
    ...
    function withdraw(address token) external {
        require(msg.sender == manager, "You are not the manager");
        manager.transfer(address(this).balance);
        SafeERC20.safeTransfer(IERC20(token), manager, IERC20(token).balanceOf(address(this)));
    }
